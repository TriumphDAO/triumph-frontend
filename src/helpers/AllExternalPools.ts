...
export const tj_gohm_wavax = new ExternalPool({
  ...
  rewardGecko: "joe", //TODO:Change address
...
export const beets_ftm_gohm_wFTM = new ExternalPool({
  ...
  stakeOn: "Beethoven",
  pairGecko: "fantom",
  rewardGecko: "beethoven-x", //TODO:Change address
...
export const sushi_arb_gohm_weth = new ExternalPool({
  ...
  stakeOn: "Sushi",
  pairGecko: "ethereum",
  rewardGecko: "sushi", //TODO:Change address
...
export const spirit_gohm_ftm = new ExternalPool({
  ...
  stakeOn: "Spirit",
  pairGecko: "fantom",
  rewardGecko: "spiritswap", //TODO:Change address
...
export const zip_gohm_weth = new ExternalPool({
  ...
  stakeOn: "Zipswap",
  pairGecko: "ethereum",
  rewardGecko: "zipswap", //TODO:Change address
